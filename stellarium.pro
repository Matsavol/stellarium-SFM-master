...
data1.path = /usr/share/stellarium/data
data1.files = data/ssystem.ini \
    data/default_config.ini \
    data/iso639-1.utf8 \
#    stellarium-0.12.4-base/data/stellarium.ico \
    data/base_locations.bin.gz \
...
data2.path = /usr/share/stellarium
data2.files = data/shaders \
    textures \
    landscapes \
    skycultures \
    nebulae \
...
data3.path = /usr/share/stellarium/stars
data3.files = stars/default

data4.path = /usr/share/stellarium/qml
data4.files = qml
    #stellarium-n9256.png


INSTALLS += data1 data2 data3 data4
#icon.path = /usr/share/icons/hicolor/86x86/apps/
#icon.files = stellarium-mobile-1.24/stellarium.png
