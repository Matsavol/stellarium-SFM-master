...
StelDialog {
	...
	Column {
		...
		Text {
            ...
            text: "<h2>Stellarium SFM v0.2<br></h2>Copyrights (C) 2017<br>Fabien &amp; Guillaume Chéreau;<br>Sailfish port: Matti Savolainen<br>GNU GPL"
			width: parent.width
		...
		Text {
			...
			color: "#2166cd"
			font.pixelSize: rootStyle.fontSmallSize
            text: "http://stellarium.org"
			MouseArea {
				anchors.fill: parent
				onClicked: {
                    Qt.openUrlExternally("http://stellarium.org")
				}
			}
		}
