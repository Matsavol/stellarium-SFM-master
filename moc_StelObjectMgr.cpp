...
struct qt_meta_stringdata_StelObjectMgr_t {
    QByteArrayData data[4];
    char stringdata0[72];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_StelObjectMgr_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_StelObjectMgr_t qt_meta_stringdata_StelObjectMgr = {
    {
QT_MOC_LITERAL(0, 0, 13), // "StelObjectMgr"
QT_MOC_LITERAL(1, 14, 21), // "selectedObjectChanged"
QT_MOC_LITERAL(2, 36, 0), // ""
QT_MOC_LITERAL(3, 37, 34) // "StelModule::StelModuleSelectA..."

    },
    "StelObjectMgr\0selectedObjectChanged\0"
    "\0StelModule::StelModuleSelectAction"
};
...
void StelObjectMgr::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (StelObjectMgr::*_t)(StelModule::StelModuleSelectAction );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&StelObjectMgr::selectedObjectChanged)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject StelObjectMgr::staticMetaObject = {
    { &StelModule::staticMetaObject, qt_meta_stringdata_StelObjectMgr.data,
      qt_meta_data_StelObjectMgr,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *StelObjectMgr::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_StelObjectMgr.stringdata0))
